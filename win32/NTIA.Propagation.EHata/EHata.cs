...
namespace NTIA.Propagation.EHata
{
    ...
    public static class EHata
    {
        ...
        public static void Invoke(float[] pfl, float f__mhz, float h_b__meter, float h_m__meter, int enviro_code, float reliability, out float plb)
        {
            plb = 0;

            EHATA(pfl, f__mhz, h_b__meter, h_m__meter, enviro_code, reliability, ref plb);
        }
